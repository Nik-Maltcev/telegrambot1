...
- `CHANNEL_USERNAME`: Имя канала комьюнити (устаревший формат, опционально)
- `CHANNEL_URL`: Полная публичная или приватная ссылка на канал (опционально)
...
Настройте `CHANNEL_URL` в `.env` для активации этой функции.
