...
CITIES = [
    ...
    "Barcelona 🇪🇸", "Madrid 🇪🇸", "Ibiza 🇪🇸", "Copenhagen 🇩🇰", "Stockholm 🇸🇪", "Lisbon 🇵🇹",
    "Vienna 🇦🇹", "Zurich 🇨🇭", "Basel 🇨🇭", "St. Moritz 🇨🇭", "Prague 🇨🇿", "Budapest 🇭🇺",
    "Warsaw 🇵🇱", "Moscow 🇷🇺", "Brussels 🇧🇪",
    "Athens 🇬🇷", "Mykonos 🇬🇷", "Marseille 🇫🇷", "Saint-Tropez 🇫🇷", "Cannes/Nice 🇫🇷",
    "Helsinki 🇫🇮",
    "Bangkok 🇹🇭", "Phuket 🇹🇭", "Ho Chi Minh City 🇻🇳", "Singapore 🇸🇬", "Hong Kong 🇭🇰", "Tokyo 🇯🇵", "Seoul 🇰🇷",
    "Shanghai 🇨🇳", "Dubai 🇦🇪",
    "Melbourne 🇦🇺",
